        ...
        <table class="auto-style1">
            <tr>
                <td>
                    ...
                    <span class="auto-style6"><strong>Character:
                    </strong>
                    </span>
                    <strong>
                    <asp:Label ID="lblCharacter" runat="server" CssClass="auto-style6"></asp:Label>
                    <br class="auto-style6" />
                    </strong>
                ...
                <td class="auto-style2">
                    ...
                    <span class="auto-style6"><strong>Character:</strong></span><strong><asp:Label ID="lblCharacterEnemy" runat="server" CssClass="auto-style6"></asp:Label>
                    <br class="auto-style6" />
                    </strong>
            ...
            <tr>
                <td class="auto-style4" colspan="3">
                    <span class="auto-style5"><strong>Experience points obtained: </strong> </span>
                    <strong>
                    <asp:Label ID="lblExpObtained" runat="server" CssClass="auto-style6"></asp:Label>
                    <br />
