        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style9">
                    ...
                    <span class="auto-style10"><strong>Character:
                    </strong>
                    </span>
                    <strong>
                    <asp:Label ID="lblCharacter" runat="server" CssClass="auto-style10"></asp:Label>
                    <br class="auto-style10" />
                    </strong>
                ...
                <td class="auto-style2">
                    ...
                    <span class="auto-style10"><strong>Character:</strong></span><strong><asp:Label ID="lblCharacterEnemy" runat="server" CssClass="auto-style10"></asp:Label>
                    <br class="auto-style10" />
                    </strong>
                    ...
                    <a href="FightOutcome.aspx"><img alt="" class="auto-style6" src="images/button/btnBeginFight.png" /></a>&nbsp;&nbsp;
                    <a href="Main.aspx"><img alt="" class="auto-style6" src="images/button/btnCancelFight.png" /></a><br />
                </td>
            </tr>
        </table>
    </form>
